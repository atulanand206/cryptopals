...
func TestSet1(t *testing.T) {
	...
	t.Run("p2 should find fixed xor test", func(t *testing.T) {
		s1 := "oz9un"
		s2 := "medium"
		_ = "746865206b696420646f6e277420706c6179"
		_, err := set1.FixedXor(s1, s2)
		if err != nil {
			t.Error()
		}
	})
	...
	t.Run("p7 should decrypt AES ECB", func(t *testing.T) {
		...
		_, err := set1.DecryptECBStrings(encrypted, key)
		if err != nil {
			t.Error()
		}
	})
